import { LAPLAND_VISUAL_PATH } from "@/lib/lapland-storefront-copy";
          ...
          return (
            <article className="travel-soft-panel overflow-hidden rounded-[1.25rem]" data-visual-beat={beat.photoId} key={beat.photoId}>
              ...
              <div className="p-4">
                ...
                {beat.credit && beat.creditPlacement === "caption" ? (
                  <p className="mt-3 text-[0.7rem] leading-5 text-slate-500" data-garnish-credit="">
                    {beat.credit}
                  </p>
                ) : null}
              </div>
