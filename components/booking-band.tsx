    ...
    <section className="travel-panel rounded-3xl p-5 sm:p-7" data-booking-band="" id="go-there">
      ...
      <div className="mt-6 grid gap-5">
        <article className="rounded-2xl border border-[color:var(--line)] bg-white/70 p-4">
          ...
          <p className="travel-muted mt-1 text-sm leading-6">
            Aviasales · {destination.originIata} → {destination.destinationIata} or {destination.extraIata}
          </p>
          <form action={AVIASALES_SEARCH_URL} className="mt-4 grid gap-3" method="get" target="_blank">
        ...
        <article className="rounded-2xl border border-[color:var(--line)] bg-white/70 p-4">
          ...
          <form action={HOTELLOOK_SEARCH_URL} className="mt-4 grid gap-3" method="get" target="_blank">
            <label className="grid gap-1">
        ...
        <article className="rounded-2xl border border-[color:var(--line)] bg-white/70 p-4">
          ...
          <p className="travel-muted mt-1 text-sm leading-6">
            Klook · {destination.city}, {destination.country}
          </p>
          <a className={`${submitClass} mt-4`} href={activitiesHref} rel="noopener noreferrer" target="_blank">
