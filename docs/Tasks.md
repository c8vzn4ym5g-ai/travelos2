...
- Clear photo = received. Uploading is a spinner. Failed is a quiet refresh
  icon (same circular glyph in the sticky dock). Tap retries held Files;
  do not re-open the album. Visible retry copy is icon-only.
