...
export type EditorTripCatalogEntry = Pick<TripDetail, "id" | "title" | "startDate" | "endDate" | "updatedAt">;
...
export function editorTripCatalogEntry(trip: EditorTripCatalogEntry): EditorTripCatalogEntry {
  ...
  return { id: trip.id, title: trip.title, startDate: trip.startDate ?? "", endDate: trip.endDate ?? "", updatedAt: trip.updatedAt ?? "" };
}
